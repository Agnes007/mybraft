...
const ::google::protobuf::EnumDescriptor* FetchAddRequest_KVType_descriptor_ = NULL;
...
void protobuf_AssignDesc_counter_2eproto() {
  ...
  static const int FetchAddRequest_offsets_[4] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(FetchAddRequest, value_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(FetchAddRequest, key_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(FetchAddRequest, val_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(FetchAddRequest, type_),
  };
  ...
  FetchAddRequest_KVType_descriptor_ = FetchAddRequest_descriptor_->enum_type(0);
...
void protobuf_AddDesc_counter_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "value\030\001 \002(\003\"\223\001\n\017FetchAddRequest\022\r\n\005value"
    "\030\001 \002(\003\022\013\n\003key\030\002 \002(\t\022\013\n\003val\030\003 \002(\t\0225\n\004type"
    "\030\004 \001(\0162\037.example.FetchAddRequest.KVType:"
    ...
    "xample.FetchAddRequest\032\030.example.Counter"
    "Response\0224\n\003get\022\023.example.GetRequest\032\030.e"
    "xample.CounterResponseB\003\200\001\001", 427);
...
const Snapshot& Snapshot::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_counter_2eproto();
...
const ::google::protobuf::EnumDescriptor* FetchAddRequest_KVType_descriptor() {
  protobuf_AssignDescriptorsOnce();
  return FetchAddRequest_KVType_descriptor_;
}
...
#ifndef _MSC_VER
const FetchAddRequest_KVType FetchAddRequest::INSERT;
const FetchAddRequest_KVType FetchAddRequest::DELETE;
const FetchAddRequest_KVType FetchAddRequest::KVType_MIN;
const FetchAddRequest_KVType FetchAddRequest::KVType_MAX;
const int FetchAddRequest::KVType_ARRAYSIZE;
#endif  // _MSC_VER
#ifndef _MSC_VER
const int FetchAddRequest::kValueFieldNumber;
const int FetchAddRequest::kKeyFieldNumber;
const int FetchAddRequest::kValFieldNumber;
const int FetchAddRequest::kTypeFieldNumber;
#endif  // !_MSC_VER
        ...
        if (tag == 32) {
         parse_type:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::example::FetchAddRequest_KVType_IsValid(value)) {
            set_type(static_cast< ::example::FetchAddRequest_KVType >(value));
          } else {
