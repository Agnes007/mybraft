...
const GetFileRequest& GetFileRequest::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_braft_2ffile_5fservice_2eproto();
...
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<GetFileRequest*>(16)->f) - \
...
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<GetFileResponse*>(16)->f) - \
   reinterpret_cast<char*>(16))
