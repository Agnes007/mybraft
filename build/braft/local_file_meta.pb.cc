...
void LocalFileMeta::SharedCtor() {
  ...
  _cached_size_ = 0;
  user_meta_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  source_ = 0;
...
void LocalFileMeta::SharedDtor() {
  if (user_meta_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete user_meta_;
  }
...
const LocalFileMeta& LocalFileMeta::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_braft_2flocal_5ffile_5fmeta_2eproto();
